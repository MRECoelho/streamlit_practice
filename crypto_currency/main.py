...
st.markdown("""
This app retrieves cryptcurrency prices from the top 100 cryptocurrencies
""")

expander_bar = st.beta_expander("About")
expander_bar.markdown("Something about...")

# layout of web out
col1 = st.sidebar
col2, col3 = st.beta_columns((2,1))  # width of col2 is twice the size of col3
...
@st.cache #use cache to avoid unnecessary scraping
def load_data():
